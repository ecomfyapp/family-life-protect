...
const disqualificationCookieName = "better_life_call6_disqualified";
const disqualificationCookieMaxAge = 60 * 60 * 24 * 180;
const callFunnelPagePath = "/call-6";
const goalOptions = [
  "Seguro de vida",
  "Ahorrar e invertir",
...
export default function Home() {
  ...
  const [pendingAgeOption, setPendingAgeOption] = useState("");
  ...
  return (
    <main className="min-h-screen bg-[var(--page-bg)] text-[var(--ink)]">
      ...
      <PopUp1
        ...
        continueUrl={buildThanksCallUrl(pendingAgeOption || answers.ageGroup, answers.insuranceGoal)}
        ringbaTags={{
          funnel_id: "call-6",
          call6_age_group: pendingAgeOption || answers.ageGroup,
        }}
